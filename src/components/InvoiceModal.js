...
import { addInvoice, editInvoice } from "../actions/invoiceActions.js";
            ...
            <Row>
              <Col md={6}>
                <Button
                  ...
                  onClick={() => GenerateInvoice(this.props)}
                >
                  <BiPaperPlane
...
function mapStateToProps(state) {
  return {
    todoState: state.invoices,
  };
}
export default withRouter(
  connect(mapStateToProps, { addInvoice, editInvoice })(InvoiceModal)
);
